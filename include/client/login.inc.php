...
<?php } ?>
    <div>
    <b><?php echo __("¿Cómo Registrarte con GMAIL?"); ?></b> <br>
    <a href="https://drive.google.com/file/d/1l732ZRvgK42-ZVQZelHwo6SswYaAIay0/view?usp=share_link" target="_blank"><?php echo __('Checa este manual'); ?></a>
    </div>
    <br>
        <div>
    <b><?php echo __("¿Usas otro servicio de correo?"); ?></b> <br>
    <a href="https://drive.google.com/file/d/1vOo6n8UN1rCiMn9jyIdSzJyd_nkexElV/view?usp=share_link" target="_blank"><?php echo __('Checa este manual y registrate con cualquier correo'); ?></a>
    </div>
    </div>
</div>
</form>
...
if ($cfg->getClientRegistrationMode() != 'disabled'
    ...
    echo sprintf(__('Si es la primera vez que te pones en contacto con nosotros puedes registrarte para levantar un nuevo ticket%s  dando clic aquí%s'),
