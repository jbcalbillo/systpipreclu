<div class="row">
<div class="span8">
    <?php echo __("Este apartado tiene como finalidad orientar a los usuarios sobre casos en los que pueden llegar a presentar problemas en su operación diaria en la plataforma de reclutamiento. En esta sección trataremos de resolver tus dudas sobre los temas más comunes en la plataforma de Reclutamiento dependiendo tu rol asignado."); ?><br>
    
    <p><b><a href="https://drive.google.com/file/d/1HgiryLX2e0xVsMcSFDQGquzYkBi-chV9/view?usp=share_link" target="_blank"><?php echo __('Consulta este manual y aprende a usar esta sección'); ?></a></b></p><br>
<?php
