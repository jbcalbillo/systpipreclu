...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'SYTPIP :: '.__('Support Ticket System');
...
if (osTicket::is_ie())
    $ost->setWarning(__('SYSTPIP no longer supports Internet Explorer.'));
?>>
<head>
    <meta charset="utf-8">
    ...
    <meta name="keywords" content="SYSTPIP, Customer support system, support ticket system">
        ...
        <div id="header">
            ...
            <?php
                ...
                if ($cfg->getClientRegistrationMode() == 'public') { ?>
                    <?php echo __('Para levantar un ticket es necesario registrarse'); ?> | <?php
                }
