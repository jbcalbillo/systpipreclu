...
define('SECRET_SALT','ph6gQuGxAP9aauiLm98OLzltSKwzuZ8C');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','juan.barrios@it-strategy.mx');
...
define('DBNAME','systpiprcl');
define('DBUSER','soportepip');
define('DBPASS','soportepip');

# Table prefix
define('TABLE_PREFIX','srcl_');
