...
<div id="loginBox">
    ...
    <h1 id="logo"><a href="index.php">
        ...
        <img src="logo.php?login" alt="SYSTPIP :: <?php echo __('Staff Control Panel');?>" />
    </a></h1>
...
<div id="poweredBy"><?php echo __('HELP DESK IDMKT'); ?>
    <a href="https://www.instagram.com/elbacardios/" target="_blank">
        <img alt="SYSTPIP" src="images/osticket-grey.png" class="osticket-logo">
    </a>
</div>
    <script>
