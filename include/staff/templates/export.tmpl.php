...
<form method="get" name="export" id="exportchecker"
    ...
    <?php echo __('Espera mientras generamos la exportación.'); ?></h3>
    </div>
    <br>
    <div style="margin-top:10px;">
    <?php
    echo sprintf(
            __("Sabemos que estás ocupado, puedes cerrar esta ventana emergente y la exportación se enviará a %s"),
            $thisstaff->getEmail());
    ?>
    </div>
    <hr>
